    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adjustment_fees', models.DecimalField(null=True, max_digits=7, decimal_places=2)),
                ('adjustment_gross', models.DecimalField(null=True, max_digits=7, decimal_places=2)),
                ('charge_count', models.IntegerField(null=True)),
                ('charge_fees', models.DecimalField(null=True, max_digits=7, decimal_places=2)),
                ...
                ('collected_fee_gross', models.DecimalField(null=True, max_digits=7, decimal_places=2)),
                ('net', models.DecimalField(null=True, max_digits=9, decimal_places=2)),
                ('refund_count', models.IntegerField(null=True)),
                ('refund_fees', models.DecimalField(null=True, max_digits=7, decimal_places=2)),
                ('refund_gross', models.DecimalField(null=True, max_digits=7, decimal_places=2)),
                ('validation_count', models.IntegerField(null=True)),
                ('validation_fees', models.DecimalField(null=True, max_digits=7, decimal_places=2)),
